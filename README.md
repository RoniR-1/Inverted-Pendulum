...
![Inverted Pendulum Demo](media/WorkingPendulum.gif)
...
* **Encoder Magnet:** Upgraded to a 6 mm diametrically magnetized magnet (the 4 mm magnet that came with the sensor was too small for reliable measurement).
...
* Additional images of the system can be found in the media folder.
---
...
![Calibration Demo](media/CalibratingPendulum.gif)
...
* **Contact:** [ronirachid459@gmail.com](mailto:ronirachid459@gmail.com) | [LinkedIn](https://www.linkedin.com/in/roni-rachid-4ab896378)
